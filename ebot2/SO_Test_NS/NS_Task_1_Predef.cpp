...
simxInt *res = new simxInt[2](),*resVis = new simxInt[2](), *obs1 = new simxInt[1](), *obs2 = new simxInt[1](), *obs3 = new simxInt[1](), *leftJoint = new simxInt[1](), *rightJoint = new simxInt[1](), *lineSensor = new simxInt[1](), *colorSensor = new simxInt[1](), *eBot0 = new simxInt[1](),*eBot = new simxInt[1](), *eBot1 = new simxInt[1](), *cuboid0 = new simxInt[1](), *cuboid = new simxInt[1](), *cuboid3 = new simxInt[1](), *cuboid4 = new simxInt[1](), *cuboid5 = new simxInt[1](),*cuboid6 = new simxInt[1](),*cuboid7 = new simxInt[1](),*proxSensor = new simxInt[1](), *proxSensor3 = new simxInt[1](), *proxSensor4 = new simxInt[1](), *visionSensor = new simxInt[1]();
...
{
	simxGetObjectHandle(ID, "LeftJoint0", leftJoint, simx_opmode_oneshot_wait);
	simxGetObjectHandle(ID, "RightJoint0", rightJoint, simx_opmode_oneshot_wait);
	simxGetObjectHandle(ID, "LineSensor0", lineSensor, simx_opmode_oneshot_wait);
	simxGetObjectHandle(ID, "ColorSensor0", colorSensor, simx_opmode_oneshot_wait);
	...
	simxGetObjectHandle(ID, "ProximitySensor0", proxSensor, simx_opmode_oneshot_wait);
        simxGetObjectHandle(ID, "ProximitySensor3", proxSensor3, simx_opmode_oneshot_wait);
        simxGetObjectHandle(ID, "ProximitySensor4", proxSensor4, simx_opmode_oneshot_wait);
...
void place(void)
{
	...
	if (place_handle != -3)
	{	
		simxSetObjectPosition(ID, place_handle, *eBot0, posPlaceRel, simx_opmode_oneshot);
		place_handle = -3;
	}
	else
