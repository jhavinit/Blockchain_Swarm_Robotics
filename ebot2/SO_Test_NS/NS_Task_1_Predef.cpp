...
simxInt *res = new simxInt[2](),*resVis = new simxInt[2](), *obs1 = new simxInt[1](), *obs2 = new simxInt[1](), *obs3 = new simxInt[1](), *leftJoint = new simxInt[1](), *rightJoint = new simxInt[1](), *lineSensor = new simxInt[1](), *colorSensor = new simxInt[1](), *eBot0 = new simxInt[1](), *eBot1 = new simxInt[1](), *cuboid0 = new simxInt[1](), *cuboid = new simxInt[1](), *cuboid3 = new simxInt[1](), *cuboid4 = new simxInt[1](), *proxSensor = new simxInt[1](), *proxSensor3 = new simxInt[1](), *proxSensor4 = new simxInt[1](), *visionSensor = new simxInt[1]();
