...
simxInt *res = new simxInt[2](),*resVis = new simxInt[2](), *obs1 = new simxInt[1](), *obs2 = new simxInt[1](), *obs3 = new simxInt[1](), *leftJoint = new simxInt[1](), *rightJoint = new simxInt[1](), *lineSensor = new simxInt[1](), *colorSensor = new simxInt[1](), *eBot0 = new simxInt[1](), *eBot1 = new simxInt[1](),*eBot = new simxInt[1](), *cuboid0 = new simxInt[1](), *cuboid = new simxInt[1](), *cuboid3 = new simxInt[1](), *cuboid4 = new simxInt[1](),*cuboid6 = new simxInt[1](),*cuboid7 = new simxInt[1](), *cuboid5 = new simxInt[1](),*proxSensor = new simxInt[1](), *proxSensor3 = new simxInt[1](), *proxSensor4 = new simxInt[1](), *visionSensor = new simxInt[1]();
...
{
	simxGetObjectHandle(ID, "LeftJoint1", leftJoint, simx_opmode_oneshot_wait);
	simxGetObjectHandle(ID, "RightJoint1", rightJoint, simx_opmode_oneshot_wait);
	simxGetObjectHandle(ID, "LineSensor1", lineSensor, simx_opmode_oneshot_wait);
	simxGetObjectHandle(ID, "ColorSensor1", colorSensor, simx_opmode_oneshot_wait);
	simxGetObjectHandle(ID, "eBot0", eBot0, simx_opmode_oneshot_wait);
        simxGetObjectHandle(ID, "eBot1", eBot1, simx_opmode_oneshot_wait);
	...
	simxGetObjectHandle(ID, "ProximitySensor5", proxSensor, simx_opmode_oneshot_wait);
        simxGetObjectHandle(ID, "ProximitySensor6", proxSensor3, simx_opmode_oneshot_wait);
        simxGetObjectHandle(ID, "ProximitySensor7", proxSensor4, simx_opmode_oneshot_wait);
        ...
        simxGetObjectHandle(ID, "cuboid1", cuboid4, simx_opmode_oneshot_wait);
        simxGetObjectHandle(ID, "cuboid2", cuboid3, simx_opmode_oneshot_wait);
...
{       unsigned int retval = 0;
        ...
        prox_error = simxReadProximitySensor(ID, *proxSensor3, &detection_state, detected_point, NULL, NULL, simx_opmode_buffer);
        else if(sel==2)
        prox_error = simxReadProximitySensor(ID, *proxSensor4, &detection_state, detected_point, NULL, NULL, simx_opmode_buffer);
...
void initProxSensor(void)
{
	...
	while (prox_error != simx_return_ok || prox_error == simx_error_novalue_flag);
       	...
       	do
		prox_error = simxReadProximitySensor(ID, *proxSensor3, NULL, NULL, NULL, NULL, simx_opmode_streaming);
	while (prox_error != simx_return_ok || prox_error == simx_error_novalue_flag);
       
       	do
		prox_error = simxReadProximitySensor(ID, *proxSensor4, NULL, NULL, NULL, NULL, simx_opmode_streaming);
	while (prox_error != simx_return_ok || prox_error == simx_error_novalue_flag);
}
...
void place(void)
{
	...
	if (place_handle != -3)
	{	
		simxSetObjectPosition(ID, place_handle, *eBot1, posPlaceRel, simx_opmode_oneshot);
		place_handle = -3;
	}
	else
...
unsigned char ADC_Conversion(unsigned char ch_no)
{
	if (ch_no == 1)	//Left Line Sensor
		...
		return getProxSensorDistance(0);
	return 255;
}
